...
sleep 2
clear
wget https://raw.githubusercontent.com/gigclone/asu/main/ssh/ssh-vpn1.sh && chmod +x ssh-vpn1.sh && ./ssh-vpn1.sh
sleep 2
clear
...
sleep 1
wget -q -O senmenu.sh https://raw.githubusercontent.com/gigclone/1/main/senmenu.sh && chmod +x senmenu.sh && ./senmenu.sh
sleep 1
